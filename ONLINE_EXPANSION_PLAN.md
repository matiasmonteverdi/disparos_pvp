...
1. **Implementar Chat y Kill Feed**: Es lo más rápido y mejora mucho la sensación de "estar conectado".
2. **Sincronizar Pickups**: Fundamental para la estrategia de control de mapa.
3. **Ciclo de Partida**: Para dar un objetivo competitivo.
